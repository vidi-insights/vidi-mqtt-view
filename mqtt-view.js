...
module.exports = function (opts) {
  ...
  seneca.add({role: 'vidi', source: 'mqtt', metric: 'process'}, process_stats)
  seneca.add({role: 'vidi', source: 'mqtt', metric: 'cpu'}, cpu_stats)
  seneca.add({role: 'vidi', source: 'mqtt', metric: 'event_loop'}, event_loop_stats)
